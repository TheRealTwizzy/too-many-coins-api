...
func registerRoutes(mux *http.ServeMux, db *sql.DB) {
	...
	mux.HandleFunc("/admin/telemetry/price-trend", adminPriceTrendHandler(db))
	mux.HandleFunc("/admin/telemetry/pressure-trend", adminPressureTrendHandler(db))
	mux.HandleFunc("/admin/telemetry/coin-metrics", adminCoinMetricsHandler(db))
	mux.HandleFunc("/admin/telemetry/flow-aggregates", adminFlowAggregatesHandler(db))
	mux.HandleFunc("/admin/telemetry/cap-tracking", adminCapTrackingHandler(db))
	...
	mux.HandleFunc("/admin/reset/telemetry", adminResetTelemetryHandler(db))
	mux.HandleFunc("/admin/reset/seasonal-stats", adminResetSeasonalStatsHandler(db))
	mux.HandleFunc("/admin/reset/season", adminResetSeasonHandler(db))
